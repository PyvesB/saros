...
public class EditorManager extends AbstractActivityProducer implements IEditorManager {
  ...
  private void addProjectResources(IProject project) {
    ...
    try {
      setLocalEditorStatusChangeHandlerEnabled(false);
      ...
      setLocalEditorStatusChangeHandlerEnabled(true);
    }
   ...
   * @see #setLocalEditorStatusChangeHandlerEnabled(boolean)
  ...
  private void setHandlersEnabled(boolean enable) {
    ...
    setLocalEditorStatusChangeHandlerEnabled(enable);
